...
| `/connect` | Connection | [Connection.README.md](./Connection.README.md) | Connect CRM account; skip or continue → onboarding |
| `/onboarding` | Onboarding | [Onboarding.README.md](./Onboarding.README.md) | Set company name & brand tone |
| `/dashboard` | Dashboard | [Dashboard.README.md](./Dashboard.README.md) | Generate copy: type, goal, context, length → /generated |
| `/generated` | GeneratedCopy | [GeneratedCopy.README.md](./GeneratedCopy.README.md) | View/copy/regenerate/send generated text |
...
- **Async safety:** Data-loading `useEffect`s use a `cancelled` flag and cleanup so `setState` is not called after unmount; copy timeouts (History, GeneratedCopy) are cleared on unmount.
