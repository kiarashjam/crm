...
- Sticky header with Cadence logo and “Sign In” link to `/login`.
...
- “Why Choose Cadence”: Save time, Simple setup, Your brand voice.
- CTA strip: “Start writing in minutes”, “Get Started Free” (→ `/login`), “No credit card required • Free forever plan”.
- Footer: Cadence blurb, Product nav (How it works, Templates, Dashboard, History, Settings, Connect CRM), Legal (Privacy, Terms, Help Center), © 2026, social (Twitter, LinkedIn, GitHub).
