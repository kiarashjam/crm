            ...
            <div className="prose prose-gray max-w-none">
              <section className="mb-8">
                ...
                <p className="text-slate-700 mb-4">
                  By accessing or using ACI, you agree to be bound by these Terms of Service and all applicable laws and regulations. If you do not agree with any of these terms, you are prohibited from using this service.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-slate-700 mb-4">
                  We grant you a limited, non-exclusive, non-transferable license to use ACI for your business purposes, subject to these terms:
                </p>
              ...
              <section className="mb-8">
                ...
                <p className="text-slate-700 mb-4">
                  ACI provides AI-powered copywriting tools that integrate with your CRM. We reserve the right to:
                </p>
                <ul className="list-disc list-inside space-y-2 text-slate-700 mb-4">
              ...
              <section className="mb-8">
                ...
                <p className="text-slate-700 mb-4">
                  <strong>Our IP:</strong> ACI, our AI models, software, and branding remain our intellectual property.
                </p>
              </section>
