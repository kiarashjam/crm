          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 md:p-12">
            ...
            <div className="prose prose-gray max-w-none">
              ...
              <section className="mb-8">
                ...
                <p className="text-slate-700 mb-4">
                  Cadence is your CRM and provides Intelligent Sales Writer tools built in. All data stays in Cadence; no external CRM integration is required. We reserve the right to:
                </p>
                <ul className="list-disc list-inside space-y-2 text-slate-700 mb-4">
              ...
              <section className="mb-8">
                ...
                <p className="text-slate-700 mb-4">
                  <strong>Your Content:</strong> You retain all rights to content you input into the service. By using our service, you grant us permission to process this content to provide our Intelligent Sales Writer features.
                </p>
                <p className="text-slate-700 mb-4">
