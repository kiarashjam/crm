...
public static class ContractTemplate
{
    ...
    public const string DefaultTemplate = """
        ...
        **Date:** {{today}}
        ...
        This agreement runs for {{contract.term}} from the start date and renews
        on the terms described in the Club's rules unless either party gives
        notice as set out in clause 4.
        ...
        **Member:** {{lead.name}}, {{lead.email}}{{lead.phoneClause}}
